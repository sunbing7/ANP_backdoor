...
from data.data_loader import get_custom_loader, get_custom_class_loader, get_data_adv_loader, get_others_cifar_loader
...
parser.add_argument('--potential_target', type=int, default=0, help='potential target class of backdoor attack')
