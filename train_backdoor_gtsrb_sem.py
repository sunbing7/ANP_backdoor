...
from data.data_loader import get_custom_gtsrb_loader
...
# backdoor parameters
parser.add_argument('--poison_type', type=str, default='semantic', choices=['badnets', 'blend', 'clean-label', 'benign', 'semantic'],
