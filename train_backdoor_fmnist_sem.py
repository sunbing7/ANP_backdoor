...
def main():
    ...
    train_mix_loader, train_clean_loader, train_adv_loader, test_clean_loader, test_adv_loader = \
        get_custom_fmnist_loader(args.batch_size, args.poison_target, args.t_attack, 100)
...
def sem_finetune():
    ...
    # Step 1: create dataset - clean val set, poisoned test set, and clean test set.
    train_mix_loader, train_clean_loader, train_adv_loader, test_clean_loader, test_adv_loader = \
        get_custom_fmnist_loader(args.batch_size, args.poison_target, args.t_attack, 500)
